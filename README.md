...
Update `package.json` and `package-lock.json` to the new version, update the direct-download links above, and commit those changes. Push a matching version tag, for example:
